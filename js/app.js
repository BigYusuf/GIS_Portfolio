...
//---
 ...
 //   }
   // Email.send({
//      Host: "smtp.gmail.com",
 //     Username: "mystik5551@gmail.com",
   //   Password: "",
  //    To: "obcessedbobos@gmail.com",
    //  From: "mystik5551@gmail.com",
  //    Subject: "New mail on contactform"+ name,
  //    Body: Body
  //  }).then(
  //    message => {
    //    if (message == 'OK') {
...
//typing 
          ...
          var typed = new Typed(".typing", {
            strings: ["GIS Analyst", "Developer", "Surveyor", "Freelancer"],
            typeSpeed: 100,
            backSpeed: 60,
            loop: true
        });
...
function send()
{
  emailjs.send("service_95gzl0e", "template_gt4hggh", {
